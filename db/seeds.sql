...
VALUES
    ('JS Juggernauts', 'The JS Juggernauts eat, breathe, and sleep JavaScript. They can bui;d everything you could ever want in JS, including a new kitchen sink.'),
    ...
    ('Git Gurus', 'Need to resolve a merge conflict? The Git Gurus hae your back. Nobody knows Git like these folks do.');
